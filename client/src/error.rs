...
use crate::bellscoin;
use crate::bellscoin::hashes::hex;
use crate::bellscoin::secp256k1;
use jsonrpc;
use serde_json;
...
pub enum Error {
    ...
    BitcoinSerialization(bellscoin::consensus::encode::Error),
    Secp256k1(secp256k1::Error),
    Io(io::Error),
    InvalidAmount(bellscoin::amount::ParseAmountError),
    InvalidCookieFile,
...
impl From<bellscoin::consensus::encode::Error> for Error {
    fn from(e: bellscoin::consensus::encode::Error) -> Error {
...
impl From<bellscoin::amount::ParseAmountError> for Error {
    fn from(e: bellscoin::amount::ParseAmountError) -> Error {
