...
pub use crate::json::bellscoin;
pub use bellscoincore_rpc_json as json;
use json::bellscoin::consensus::{Decodable, ReadExt};
use json::bellscoin::hashes::hex::HexIterator;
...
fn deserialize_hex<T: Decodable>(hex: &str) -> Result<T> {
    ...
    if reader.read_u8().is_ok() {
        Err(Error::BitcoinSerialization(bellscoin::consensus::encode::Error::ParseFailed(
