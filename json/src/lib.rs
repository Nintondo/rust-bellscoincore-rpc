...
#![crate_name = "bellscoincore_rpc_json"]
#![crate_type = "rlib"]

pub extern crate bellscoin;
#[allow(unused)]
...
use bellscoin::address::NetworkUnchecked;
use bellscoin::block::Version;
use bellscoin::consensus::encode;
...
pub struct GetNetworkInfoResult {
    ...
    #[serde(rename = "relayfee", with = "bellscoin::amount::serde::as_btc")]
    pub relay_fee: Amount,
    #[serde(rename = "incrementalfee", with = "bellscoin::amount::serde::as_btc")]
...
pub struct GetWalletInfoResult {
    ...
    #[serde(rename = "paytxfee", with = "bellscoin::amount::serde::as_btc")]
    pub pay_tx_fee: Amount,
    #[serde(rename = "hdseedid")]
    pub hd_seed_id: Option<bellscoin::hash_types::XpubIdentifier>,
...
pub struct GetBlockHeaderResult {
    ...
    pub merkle_root: bellscoin::hash_types::TxMerkleNode,
    pub time: usize,
    ...
    pub previous_block_hash: Option<bellscoin::BlockHash>,
    #[serde(rename = "nextblockhash")]
    pub next_block_hash: Option<bellscoin::BlockHash>,
}

#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
pub struct GetBlockStatsResult {
    #[serde(rename = "avgfee", with = "bellscoin::amount::serde::as_sat")]
    pub avg_fee: Amount,
    #[serde(rename = "avgfeerate", with = "bellscoin::amount::serde::as_sat")]
    pub avg_fee_rate: Amount,
    #[serde(rename = "avgtxsize")]
    pub avg_tx_size: u32,
    #[serde(rename = "blockhash")]
    pub block_hash: bellscoin::BlockHash,
    #[serde(rename = "feerate_percentiles")]
    pub fee_rate_percentiles: FeeRatePercentiles,
    pub height: u64,
    pub ins: usize,
    #[serde(rename = "maxfee", with = "bellscoin::amount::serde::as_sat")]
    pub max_fee: Amount,
    #[serde(rename = "maxfeerate", with = "bellscoin::amount::serde::as_sat")]
    pub max_fee_rate: Amount,
    #[serde(rename = "maxtxsize")]
    pub max_tx_size: u32,
    #[serde(rename = "medianfee", with = "bellscoin::amount::serde::as_sat")]
    pub median_fee: Amount,
    #[serde(rename = "mediantime")]
    pub median_time: u64,
    #[serde(rename = "mediantxsize")]
    pub median_tx_size: u32,
    #[serde(rename = "minfee", with = "bellscoin::amount::serde::as_sat")]
    pub min_fee: Amount,
    #[serde(rename = "minfeerate", with = "bellscoin::amount::serde::as_sat")]
    pub min_fee_rate: Amount,
    #[serde(rename = "mintxsize")]
    pub min_tx_size: u32,
    pub outs: usize,
    #[serde(with = "bellscoin::amount::serde::as_sat")]
    pub subsidy: Amount,
    ...
    #[serde(rename = "totalfee", with = "bellscoin::amount::serde::as_sat")]
...
pub struct GetBlockStatsResultPartial {
    #[serde(
        default,
        rename = "avgfee",
        with = "bellscoin::amount::serde::as_sat::opt",
    ...
    pub block_hash: Option<bellscoin::BlockHash>,
...
pub struct GetRawTransactionResultVin {
    ...
    pub txid: Option<bellscoin::Txid>,
    /// Not provided for coinbase txs.
    pub vout: Option<u32>,
...
pub struct GetRawTransactionResult {
    ...
    #[serde(with = "crate::serde_hex")]
    pub hex: Vec<u8>,
    pub txid: bellscoin::Txid,
    pub hash: bellscoin::Wtxid,
    pub size: usize,
    pub vsize: usize,
    pub version: u32,
    pub locktime: u32,
    ...
    pub blockhash: Option<bellscoin::BlockHash>,
...
pub struct GetBlockFilterResult {
    pub header: bellscoin::hash_types::FilterHash,
    #[serde(with = "crate::serde_hex")]
    pub filter: Vec<u8>,
}
...
pub struct GetTransactionResultDetail {
    ...
    pub vout: u32,
    #[serde(default, with = "bellscoin::amount::serde::as_btc::opt")]
...
pub struct WalletTxInfo {
    ...
    pub wallet_conflicts: Vec<bellscoin::Txid>,
}
...
pub struct ListSinceBlockResult {
    ...
    pub lastblock: bellscoin::BlockHash,
}

#[derive(Clone, PartialEq, Eq, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetTxOutResult {
    pub bestblock: bellscoin::BlockHash,
...
pub struct ListUnspentQueryOptions {
    #[serde(
        ...
        with = "bellscoin::amount::serde::as_btc::opt",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct GetBlockchainInfoResult {
    ...
    pub best_block_hash: bellscoin::BlockHash,
...
pub struct GetMempoolInfoResult {
    ...
    #[serde(rename = "mempoolminfee", with = "bellscoin::amount::serde::as_btc")]
    pub mempool_min_fee: Amount,
    /// Current minimum relay fee for transactions
    #[serde(rename = "minrelaytxfee", with = "bellscoin::amount::serde::as_btc")]
    pub min_relay_tx_fee: Amount,
    /// Minimum fee rate increment for mempool limiting or replacement in BTC/kvB
    #[serde(rename = "incrementalrelayfee", with = "bellscoin::amount::serde::as_btc")]
...
pub struct GetMempoolEntryResult {
    ...
    pub wtxid: bellscoin::Txid,
    /// Fee information
    pub fees: GetMempoolEntryResultFees,
    /// Unconfirmed transactions used as inputs for this transaction
    pub depends: Vec<bellscoin::Txid>,
    /// Unconfirmed transactions spending outputs from this transaction
    #[serde(rename = "spentby")]
    pub spent_by: Vec<bellscoin::Txid>,
...
pub struct GetPeerInfoResult {
    ...
    #[serde(rename = "minfeefilter", default, with = "bellscoin::amount::serde::as_btc::opt")]
...
pub struct GetBlockTemplateResult {
    ...
    #[serde(rename = "previousblockhash")]
    pub previous_block_hash: bellscoin::BlockHash,
    ...
    #[serde(default, with = "bellscoin::script::ScriptBuf")]
    pub signet_challenge: bellscoin::script::ScriptBuf,
    ...
    /// is activated.
    #[serde(with = "bellscoin::script::ScriptBuf", default)]
    pub default_witness_commitment: bellscoin::script::ScriptBuf,
    ...
    #[serde(rename = "coinbasevalue", with = "bellscoin::amount::serde::as_sat", default)]
...
/// A wrapper around bellscoin::EcdsaSighashType that will be serialized
/// according to what the RPC expects.
pub struct SigHashType(bellscoin::sighash::EcdsaSighashType);

impl From<bellscoin::sighash::EcdsaSighashType> for SigHashType {
    fn from(sht: bellscoin::sighash::EcdsaSighashType) -> SigHashType {
        SigHashType(sht)
    }
}
...
impl serde::Serialize for SigHashType {
        ...
        S: serde::Serializer,
    {
        serializer.serialize_str(match self.0 {
            bellscoin::sighash::EcdsaSighashType::All => "ALL",
            bellscoin::sighash::EcdsaSighashType::None => "NONE",
            bellscoin::sighash::EcdsaSighashType::Single => "SINGLE",
            bellscoin::sighash::EcdsaSighashType::AllPlusAnyoneCanPay => "ALL|ANYONECANPAY",
            bellscoin::sighash::EcdsaSighashType::NonePlusAnyoneCanPay => "NONE|ANYONECANPAY",
            bellscoin::sighash::EcdsaSighashType::SinglePlusAnyoneCanPay => "SINGLE|ANYONECANPAY",
        })
    }
}
...
pub struct GetTxOutSetInfoResult {
    ...
    pub best_block: bellscoin::BlockHash,
...
pub struct ScanTxOutResult {
    ...
    pub height: Option<u64>,
    #[serde(rename = "bestblock")]
    pub best_block_hash: Option<bellscoin::BlockHash>,
    pub unspents: Vec<Utxo>,
    #[serde(with = "bellscoin::amount::serde::as_btc")]
    pub total_amount: bellscoin::Amount,
}
...
pub struct Utxo {
    pub txid: bellscoin::Txid,
    pub vout: u32,
    pub script_pub_key: bellscoin::ScriptBuf,
    #[serde(rename = "desc")]
    pub descriptor: String,
    #[serde(with = "bellscoin::amount::serde::as_btc")]
    pub amount: bellscoin::Amount,
    pub height: u64,
}
